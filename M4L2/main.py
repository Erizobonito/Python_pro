...
'''
Entro a la terminal usando el comando ctrl + shift + i
Entro a la carpeta en la que estoy trabajando usando cd
Escribo python y me tiene que salir asi
>>>
Luego de eso escribo 
...
def login():
        ...
        if request.method == 'POST':
            ...
            for user in users_db:
                if form_loggin==user.loggin and form_password == users.password:
